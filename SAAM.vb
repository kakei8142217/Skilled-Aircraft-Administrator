Public Class SAAM
    Public saam As SAAM
    Dim saaupd As New Xml.XmlDocument


    Private Sub SAAM_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        saam = Me
        ...
        filecontrol.checkplaneupdata()

        Dim baseshipcount As Integer = 1
        Do While baseship.getid(baseshipcount) <> 0
            ComboBox1.Items.Add(baseship.getattribute(baseship.getid(baseshipcount), 1))
            baseshipcount = baseshipcount + 1
        Loop
        ComboBox1.Items.Add（"<点击加载未改造舰娘>"）

        For a = 0 To 19
            ship(a) = New ship_class(a)
        Next
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        If ComboBox1.SelectedIndex >= 0 Then
            ...
            For a = 0 To 9
                If ship(a).active = False Then
                    For b = 0 To 19
                        If ship(b).active = True Then
                            If Val(Mid(Trim(ship(b).uniquecode), 1, 3)) = baseship.getid(ComboBox1.SelectedIndex + 1) Then
                                If Asc(Mid(Trim(ship(b).uniquecode), Len(Trim(ship(b).uniquecode)), 1)) > code Then
                                    code = Asc(Mid(Trim(ship(b).uniquecode), Len(Trim(ship(b).uniquecode)), 1))
                                End If
                            End If
                        End If
                    Next
                    ship(a).uniquecode = Format(baseship.getid(ComboBox1.SelectedIndex + 1), "000") & Chr(code + 1)
                    For b = 0 To 4
                        If baseship.getattribute(ship(a).uniquecode, b + 8) > 0 Then
                            vessel.clear()
                            vessel.amount = baseship.getattribute(ship(a).uniquecode, b + 8)
                            vessel.shipid = a
                            vessel.carryid = b
                            vessel.uniquecode = ship(a).uniquecode & b
                            ship(a).setcarry(vessel)
                        End If
                    Next
                    ship(a).restrict = baseship.getattribute(ship(a).uniquecode, 22) * 10 + 0
    ...
    Private Sub list1refresh()
        ...
        Do While UIcontrol.showstringlist1(num) <> ""
            ListBox1.Items.Add(UIcontrol.showstringlist1(num))
            num = num + 1
        Loop
    End Sub
    ...
    Private Sub list2refresh()
        ...
        Dim num As Integer = 1
        Do While UIcontrol.showstringlist2(num, ListBox1.SelectedIndex) <> ""
            ListBox2.Items.Add(UIcontrol.showstringlist2(num, ListBox1.SelectedIndex))
            num = num + 1
        Loop
    End Sub
    ...
    Private Sub ListBox1_Click(sender As Object, e As EventArgs) Handles ListBox1.Click
        ...
        Dim num As Integer = 1
        Do While UIcontrol.showstringcombo2(num, ListBox1.SelectedIndex) <> ""
            ComboBox2.Items.Add(UIcontrol.showstringcombo2(num, ListBox1.SelectedIndex))
            num = num + 1
        Loop
        Call list2refresh()
        If UIcontrol.getshipid(ListBox1.SelectedIndex) <> -1 Then
            ComboBox2.SelectedIndex = ship(UIcontrol.getshipid(ListBox1.SelectedIndex)).restrict - Int(ship(UIcontrol.getshipid(ListBox1.SelectedIndex)).restrict / 10) * 10
        End If
    End Sub
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        If ListBox1.SelectedIndex >= 0 Then
            ...
            If ComboBox2.SelectedIndex >= 0 Then
                UIcontrol.setshipattribute(ListBox1.SelectedIndex, ComboBox2.SelectedIndex)
                Call list1refresh()
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        UIcontrol.removeship(ListBox1.SelectedIndex)
        Call list1refresh()
        Call list2refresh()
    End Sub
    ...
    Private Sub Button6_Click(sender As Object, e As EventArgs) Handles Button6.Click
        ...
        For a = 0 To 19
            If ship(a).active = True Then
                If ship(a).shellingfire = 0 And restrictcontrol.getrestrictattribute(a, 4) <= 1 And ship(a).carrycount >= 3 Then
                    UIcontrol.adderror(101 * 100 + a)
                End If
                If restrictcontrol.getrestrictattribute(a, 4) = 1 And restrictcontrol.CIstate(ship(a).getcarry(0)) <> 1.25 Then
                    UIcontrol.adderror(102 * 100 + a)
                End If
                If restrictcontrol.getrestrictattribute(a, 4) = 5 And restrictcontrol.CIstate(ship(a).getcarry(0)) <= 1 Then
                    UIcontrol.adderror(102 * 100 + a)
                End If
                If a >= (Val(onlysfnf) * 10) * -1 Then
                    If restrictcontrol.getrestrictattribute(a, 10) - restrictcontrol.getrestrictattribute(a, 7) < 0 Then
                        UIcontrol.adderror(103 * 100 + a)
                    End If
    ...
    Private Sub Button8_Click(sender As Object, e As EventArgs) Handles Button8.Click
        UIcontrol.exportconfigurecode()
    End Sub

    Private Sub ComboBox3_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox3.SelectedIndexChanged
        plane.loadplanedata(ComboBox3.SelectedIndex)
    End Sub

    Private Sub Button9_Click(sender As Object, e As EventArgs) Handles Button9.Click
        'ListBox2.Items.Add(plane.getplane(4, 13, 0))
        ListBox2.Items.Add(plane.getattribute(15701, 1))
    ...
    Private Sub matchingcplane(ByVal ffexpectaavalue As Integer, ByVal cfexpectaavalue As Integer)
        ...
        If cplanegroup.carrycount <> 0 Then     '第二次装填舰战容器
            For a = 0 To cplanegroup.carrycount - 1
                ...
                If vessel.planeid = 0 Then
                    ...
                    End If
                    If restrictcontrol.getrestrictattribute(vessel.shipid, 4) + restrictcontrol.getrestrictattribute(vessel.shipid, 7) = ship(vessel.shipid).carrycount Then
                        carrygroup.setcarry(vessel, 11)
                    End If
                End If
            Next
        ...
        For l = 0 To 1
                        ...
                        If CheckBox4.Checked = False Then
                            For a = 0 To ctorpedogroup.carrycount - 1
                                ...
                                If restrictcontrol.CIstate(vessel) < 1 Then
                                    If baseship.getattribute(ship(vessel.shipid).uniquecode, 18) = 1 Then
                                        If Not (plane.getattribute(vessel.planeid, 16) <> 0 And restrictcontrol.nfstate(vessel) > 1) Then
                                            getplaneid = plane.getplane(5)
                                            If getplaneid <> 0 Then
                                                If getcarrycount < round Then
            ...
            If cfightergroup.carrycount <> 0 Then
                For a = 0 To cfightergroup.carrycount - 1
                    vessel = cfightergroup.getcarry(a)
                    ship(vessel.shipid).setcarry(vessel)
                Next
            End If
            ...
            If ship(a).active = True Then
                If restrictcontrol.getrestrictattribute(a, 9) > 0 Then     '装载水爆容器
                    For b = 1 To restrictcontrol.getrestrictattribute(a, 9)
                        wboomergroup.setcarry(ship(a).getcarry(11))
                    Next
                End If

                If restrictcontrol.getrestrictattribute(a, 8) > 0 Then    '装载水上机容器
                    If baseship.getattribute(ship(a).uniquecode, 19) = 0 Then
                        For b = 1 To restrictcontrol.getrestrictattribute(a, 8)
                            wplanegroup.setcarry(ship(a).getcarry(11))
                        Next
                    End If
                End If
            End If
            ...
            For b = 0 To 19
                If ship(b).active = True Then
                    If restrictcontrol.getrestrictattribute(b, 8) > 0 Then     '第二次装载水战容器
                        If baseship.getattribute(ship(b).uniquecode, 21) = 4 - a Then
                            If baseship.getattribute(ship(b).uniquecode, 21) >= 3 And restrictcontrol.getrestrictattribute(b, 8) <= 2 Then
                                For c = 1 To restrictcontrol.getrestrictattribute(b, 8)
                                    auxiliarygruop.setcarry(ship(b).getcarry(11), 11)
                                Next
                            End If
                        End If
                    End If
            ...
            For b = 0 To 19
                If ship(b).active = True Then
                    If restrictcontrol.getrestrictattribute(b, 8) > 0 Then
                        If baseship.getattribute(ship(b).uniquecode, 21) = 4 - a Then
                            If Not (baseship.getattribute(ship(b).uniquecode, 21) >= 3 And restrictcontrol.getrestrictattribute(b, 8) <= 2) Then
                                For c = 1 To restrictcontrol.getrestrictattribute(b, 8)
                                    auxiliarygruop.setcarry(ship(b).getcarry(11), 11)
                                Next
                            End If
